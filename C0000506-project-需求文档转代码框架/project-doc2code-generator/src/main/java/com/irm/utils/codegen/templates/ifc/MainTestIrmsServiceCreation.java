...
import com.irm.utils.codegen.templates.ifc.tools.TestIrmsServiceGenerator;
import com.irm.utils.codegen.utils.CodeGenTemplateExecutor;
import com.irm.utils.codegen.utils.Comment;

@Comment("hello")
public class MainTestIrmsServiceCreation {
	@SuppressWarnings("unused")
	private static final transient Log log = LogFactory.getLog(MainTestIrmsServiceCreation.class);
	...
	public static void main(String[] args) throws Exception {
		...
		TestIrmsServiceGenerator genTest = new TestIrmsServiceGenerator();
