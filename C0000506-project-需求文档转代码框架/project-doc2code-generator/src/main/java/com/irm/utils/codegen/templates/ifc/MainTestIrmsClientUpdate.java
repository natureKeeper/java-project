...
import com.irm.utils.codegen.templates.ifc.tools.TestIrmsClient2Generator;
import com.irm.utils.codegen.utils.CodeGenTemplateExecutor;
import com.irm.utils.codegen.utils.Comment;

@Comment("hello")
public class MainTestIrmsClientUpdate {
	@SuppressWarnings("unused")
	private static final transient Log log = LogFactory.getLog(MainTestIrmsClientUpdate.class);
	...
	public static void main(String[] args) throws Exception {
		...
		TestIrmsClient2Generator genTest = new TestIrmsClient2Generator();
