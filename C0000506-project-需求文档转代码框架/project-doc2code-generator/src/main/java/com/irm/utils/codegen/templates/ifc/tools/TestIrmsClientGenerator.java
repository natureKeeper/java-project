...
public class TestIrmsClientGenerator extends GeneralGenerator {
	@SuppressWarnings("unused")
	private static final transient Log log = LogFactory.getLog(TestIrmsClientGenerator.class);
	...
	public void inputInformation(InformationContainer infoContainer) {
		...
		map.put(Const.INTERFACE_METHOD_CN_NAME_IN_T3DOC, "qq消息发送接口");
		map.put(Const.INTERFACE_METHOD_ENUM_CONST, "SEND_QQ_MSG");
		...
		map.put(Const.JAVA_SERVICE_METHODNAME, "sendQqMessage");
		map.put(Const.METHOD_DESCRIPTION, "这是qq消息发送方法");
		map.put(Const.SERVICE_CLIENT_SYSTEM_CODE_UPPERCASE, "IRMS");
		map.put(Const.SERVICE_SERVER_SYSTEM_CODE_UPPERCASE, "DEMO");
		
		map.put(Const.INTERFACE_METHOD_EN_CODE_IN_T3DOC, "faSongQqXiaoXi");
