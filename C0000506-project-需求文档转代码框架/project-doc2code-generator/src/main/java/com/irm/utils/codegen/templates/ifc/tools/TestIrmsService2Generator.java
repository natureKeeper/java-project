...
public class TestIrmsService2Generator extends GeneralGenerator {
	@SuppressWarnings("unused")
	private static final transient Log log = LogFactory.getLog(TestIrmsService2Generator.class);
	...
	public void inputInformation(InformationContainer infoContainer) {
		...
		map.put(Const.INTERFACE_METHOD_CN_NAME_IN_T3DOC, "msn消息接收接口");
		map.put(Const.INTERFACE_METHOD_ENUM_CONST, "RECEIVE_MSN_MSG");
		...
		map.put(Const.JAVA_SERVICE_METHODNAME, "receiveMsnMessage");
		map.put(Const.METHOD_DESCRIPTION, "这是msn消息接收方法");
		map.put(Const.SERVICE_CLIENT_SYSTEM_CODE_UPPERCASE, "DEMO");
		map.put(Const.SERVICE_SERVER_SYSTEM_CODE_UPPERCASE, "IRMS");
		
		map.put(Const.INTERFACE_METHOD_EN_CODE_IN_T3DOC, "jieShouMsnXiaoXi");
