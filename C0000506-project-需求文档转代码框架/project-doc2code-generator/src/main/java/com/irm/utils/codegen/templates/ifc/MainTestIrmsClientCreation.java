...
import com.irm.utils.codegen.templates.ifc.tools.TestIrmsClientGenerator;
import com.irm.utils.codegen.utils.CodeGenTemplateExecutor;
import com.irm.utils.codegen.utils.Comment;

@Comment("hello")
public class MainTestIrmsClientCreation {
	@SuppressWarnings("unused")
	private static final transient Log log = LogFactory.getLog(MainTestIrmsClientCreation.class);
	...
	public static void main(String[] args) throws Exception {
		...
		TestIrmsClientGenerator genTest = new TestIrmsClientGenerator();
