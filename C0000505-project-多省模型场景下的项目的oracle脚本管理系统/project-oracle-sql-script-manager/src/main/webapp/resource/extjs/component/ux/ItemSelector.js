...
Ext.ux.form.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
        ...
        // edit by fanyong
        var _toLegend  = 'Available';
        var _fromLegend = 'Available';
        if(!Ext.isEmpty(this.toLegend)){
            _toLegend = this.toLegend;
        }
        if(!Ext.isEmpty(this.fromLegend)){
            _fromLegend = this.fromLegend;
        }
        var msConfig = [{
            legend: _fromLegend,
            draggable: true,
