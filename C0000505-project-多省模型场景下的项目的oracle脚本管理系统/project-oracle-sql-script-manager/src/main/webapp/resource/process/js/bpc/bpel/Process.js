...
//*************************************************************************
//
// Workfile: BPCSRVR/ws/code/processwidget/src/WebContent/bpc/bpel/Process.js, BPC.client, WBIX.BPCSRVR, of0947.12
// Last update: 09/11/10 07:05:35
// SCCS path, id: /family/botp/vc/13/6/9/1/s.82 1.8
//
//*************************************************************************
//END CMVC
//BEGIN COPYRIGHT
...
//*************************************************************************
//END COPYRIGHT
dojo.provide("bpc.bpel.Process");

dojo.require("bpc.bpel.Sequential");

dojo.declare("bpc.bpel.Process", bpc.bpel.Sequential, {
