	...
	dojo.declare('dojox.grid._View', [dijit._Widget, dijit._Templated], {
		...
		adaptHeight: function(minusScroll){
			if(!this.grid._autoHeight){
				...
				if(dojo.isIE && this.noscroll){
					//IE continues to have issues with keeping
					//row alignment.  Without this patch, views that
					//are 'noscroll' will msialign on calls to 
					//grid.update() calls.
					var self = this;
					...
					if(minusScroll || checkOtherViewScrollers()){
