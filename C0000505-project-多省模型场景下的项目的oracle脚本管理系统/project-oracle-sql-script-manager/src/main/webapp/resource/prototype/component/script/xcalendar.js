...
b='<style>';
b+='.c_text_normal { font-size:12px; cursor:hand; font-family:Verdana; color:#000; font-weight:normal; }';
b+='.c_text_over { font-size:12px; cursor:hand; font-family:Verdana; color:#000; font-weight:bolder;}'; 
b+='</style>';
b+='';
b+='<scr' + 'ipt>';
b+='		var datelayerx,datelayery;	/*存放日历控件的鼠标位置*/';
b+='		var bDrag = false;	/*标记是否开始拖动*/';
b+='		function document.onmousemove() {	/*在鼠标移动事件中，如果开始拖动日历，则移动日历*/';
b+='			if(bDrag && window.event.button==1) {';
b+='				var DateLayer=parent.document.all.meizzDateLayer.style;';
b+='				DateLayer.posLeft += window.event.clientX-datelayerx;/*由于每次移动以后鼠标位置都恢复为初始的位置，因此写法与div中不同*/';
b+='				DateLayer.posTop += window.event.clientY-datelayery;}}';
b+='		function DragStart() {		/*开始日历拖动*/';
b+='			var DateLayer=parent.document.all.meizzDateLayer.style;';
b+='			datelayerx=window.event.clientX;';
b+='			datelayery=window.event.clientY;';
b+='			bDrag=true;}';
b+='		function DragEnd() {		/*结束日历拖动*/';
b+='			bDrag=false;}';
// vigor add begin
b+='		function text_over(the) { the.className = "c_text_over";}';
b+='		function text_out(the) { the.className = "c_text_normal";}';
// vigor add end
b+='</scr' + 'ipt>';
b+='';
b+='<div style="z-index:9999;position: absolute; left:0; top:0; " onselectstart="return false"> ';
b+='<span id=tmpSelectYearLayer author=wayx style="z-index: 9999;position: absolute;top: 2; left: 15;display: none"></span>';
b+='<span id=tmpSelectMonthLayer author=wayx style="z-index: 9999;position: absolute;top: 2; left: 107;display: none"></span>';
b+='<span id=tmpSelectTimeLayer author=wayx style="z-index: 9999;position: absolute;top: 153; left: 3;display: none"></span>';
b+='<table border=0 cellspacing=0 cellpadding=0 width=170 height=176 style="border:1px solid #000" bgcolor=#FFFFFF>';
b+='<tr><td>';
b+='';
b+='<table border=0 cellspacing=0 cellpadding=0 width=100% author="wayx" height=23 bgcolor="#E9F0F4"><tr align=center author="wayx">';
b+='		<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='   	 	width=16 onclick="parent.meizzPrevY()" title="向前翻 1 年">&lt;</td>';
b+='     <td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='			width=60 onclick="parent.tmpSelectYearInnerHTML(this.innerText.substring(0,4))" ';
b+='			title="点击这里选择年份"><span id=meizzYearHead></span></td>';
b+='  	<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='   		width=16 onclick="parent.meizzNextY()" title="向后翻 1 年">&gt;</td>';
b+='		<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='     	width=16 onclick="parent.meizzPrevM()" title="向前翻 1 月">&lt;</td>';
b+='		<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='  		width=43 onclick="parent.tmpSelectMonthInnerHTML(this.innerText.length==3?this.innerText.substring(0,1):this.innerText.substring(0,2))"';
b+='        	title="点击这里选择月份"><span id=meizzMonthHead></span></td>';
b+='     <td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='         width=16 onclick="parent.meizzNextM()" title="向后翻 1 月">&gt;</td>';
b+='</tr></table>';
b+='';
b+='</td></tr><tr><td>';
b+='';
b+='<table border=0 cellspacing=0 cellpadding=0 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
b+='  width=98% height=20 author="wayx" style="border-bottom:1px solid #000;cursor:' + (bMoveable ? 'move':'default') + '" align="center">';
b+='<tr author="wayx" style="font-size:12px;" align=center valign=bottom>';
b+='		<td author=meizz>日</td>';
b+='		<td author=meizz>一</td>';
b+='		<td author=meizz>二</td>';
b+='		<td author=meizz>三</td>';
b+='		<td author=meizz>四</td>';
b+='		<td author=meizz>五</td>';
b+='		<td author=meizz>六</td>';
b+='</tr></table>';
b+='';
b+='</td></tr><!-- author:F.R.Huang(meizz) http://www.meizz.com/ mail: meizz@hzcnc.com 2002-10-8 -->';
b+='<tr><td>';
b+='';
b+='<table border=0 cellspacing=0 cellpadding=0 width=100% height=108>';
	var n=0; 
	for (j=0;j<6;j++) { 
		b+= ' <tr align=center>'; 
		for (i=0;i<7;i++){
			b+='<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
			b+='		width=24 height=18 id=meizzDay'+n+' onclick=parent.meizzDayClick(this.innerText,0)></td>';
			n++;
		}
		b+='</tr>';
	}
...
//	for (i=35;i<39;i++)  {
//		b+='<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
//		b+='		width=24 height=18 id=meizzDay'+i+' onclick="parent.meizzDayClick(this.innerText,0)"></td>';
//	}
//b+='<td colspan=3>&nbsp;</td></tr>'; //' + _VersionInfo + '
b+='</table>';
b+='';
b+='</td></tr><tr><td>';
b+='';
b+='<table border=0 cellspacing=0 cellpadding=0 width=100% height="23" bgcolor=#E9F0F4><tr>';
b+='		<td align=center width="70" class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" '; 
//b+='			onclick="parent.tmpSelectTimeInnerHTML()"><span id=meizzTime>18:00</span></td>'; //' + _VersionInfo + '
b+='			onclick="parent.tmpSelectTimeInnerHTML()"><span id=meizzTime>18:00</span></td>'; //' + _VersionInfo + '
b+='		<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" '; 
b+='			width="49" onclick=parent.setnull() title="置空">置空</td>'; //' + _VersionInfo + '
b+='  	<td align=center class="c_text_normal" onmouseover="text_over(this);" onmouseout="text_out(this);" ';
b+='   		width="49" onclick="parent.meizzToday()" title="今天">今天</td>';
b+='</tr></table>';
b+='';
b+='</td></tr></table></div>';
...
window.frames.meizzDateLayer.document.writeln(b);
...
function tmpSelectYearInnerHTML(strYear) //年份的下拉框
{
  ...
  if (n < 1753) n = 1753;
  if (n + 26 > 9999) n = 9974;
  var s = "<select author=meizz name=tmpSelectYear style='font-size:12;font-family:Verdana;' "
...
function tmpSelectMonthInnerHTML(strMonth) //月份的下拉框
{
  ...
  var s = "<select author=meizz name=tmpSelectMonth style='font-size:12;font-family:Verdana;' "
...
function tmpSelectTimeInnerHTML() {
	...
	*/
	var	clockSelect = "";
	clockSelect += "<select name=c_Time style='width:68;font-size:12;font-family:Verdana;'"
